...
const api_url = " https://yumnadma11.herokuapp.com/user";
...
function loadData(records = []) {
	...
	for(let i=0; i<records.length; i++) {
		...
		table_data += `<td>${records[i].req}</td>`;
...
function postData() {
   ...
   data = {name: name, age: age, email: email, reqdomain: reqdomain, req: req};
...
function putData() {
	...
	data = {_id: _id, name: name, age: age, email: email, reqdomain: reqdomain, req: req};
