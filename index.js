// https://yumnadma11.herokuapp.com/ | https://git.heroku.com/yumnadma11.git
...
app.get("/", (req, res) => {
	res.send("Welcome to Service Management Portal");
});
...
app.get("/user/:id", async (req, res) => {
	...
	let data = await User.find({"_id": req.params.id});  //params is used when id: - colon is used
	res.send(data[0]);
});
